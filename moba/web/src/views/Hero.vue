        ...
        <swiper-slide>
          <div>
            <div class="bg-white p-3 border-bottom">
              ...
              <!-- skills -->
              <div class="bg-white skills mt-4">
                <div class="d-flex jc-around">
                  <img :src="item.icon" 
                  v-for="(item,i) in model.skills" :key="item.name" 
                  class="icon" @click="currentSkillIndex=i"
            ...
            <m-card plain class="hero-items" icon="Menu" title="出装推荐">
              <div class="fs-xl">顺风出装</div>
              <div class="d-flex jc-center mt-3 text-center">
            ...
            <m-card plain icon="Menu" title="英雄关系">
              ...
              v-for="item in model.partners" :key="item.name">
